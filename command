...
mkdir PaymentServices.AccountResolution
cd PaymentServices.AccountResolution

# 2. Create solution
dotnet new sln -n PaymentServices.AccountResolution

# 3. Create worker project
mkdir src
cd src
dotnet new worker -n PaymentServices.AccountResolution -f net10.0
cd ..

# 4. Add to solution
dotnet sln add src/PaymentServices.AccountResolution.csproj
