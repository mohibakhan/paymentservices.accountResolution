...
public sealed class AccountResolutionSettings : AppSettings
{
    ...
    /// <summary>
    /// Skip destination account lookup when false.
    /// This is used for environments where destination resolution is not required.
    /// </summary>
    public bool DESTINATION_ACCOUNT_LOOKUP_ENABLED { get; set; } = true;
