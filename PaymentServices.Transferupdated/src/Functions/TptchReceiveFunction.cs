...
public sealed class TptchReceiveFunction
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var result = await _receiveTransferService.ExecuteAsync(message, cancellationToken);
            ...
            ex is LimitExceededException or ScreeningRejectedException)
        {
            ...
            var failedStage = message.LimitPassed ? "SCREENING" : "LIMIT";
            ...
            return await WriteResponseAsync(req, HttpStatusCode.OK, new TptchReceiveResponse
            {
                ...
                LimitPassed = message.LimitPassed,
                ScreeningPassed = message.ScreeningPassed,
                LedgerPosted = false,
        ...
        catch (Exception ex)
        {
            ...
            var failedStage = !message.LimitPassed ? "LIMIT"
                : !message.ScreeningPassed ? "SCREENING"
                : "LEDGER";
            ...
            return await WriteResponseAsync(req, HttpStatusCode.InternalServerError, new TptchReceiveResponse
            {
                ...
                LimitPassed = message.LimitPassed,
                ScreeningPassed = message.ScreeningPassed,
                LedgerPosted = message.LedgerPosted,
                FailedStage = failedStage,
                Reason = ex.Message
            }, cancellationToken);
        }
